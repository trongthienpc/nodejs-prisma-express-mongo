 ...
 */
router.get("/", checkAuthenticated, branchController.getItems);
 ...
 *         description: Internal server error
 */
router.post("/", checkAuthenticated, branchController.createItem);
 ...
 *         description: Internal server error
 */
router.get("/:id", checkAuthenticated, branchController.getItemById);
 ...
 *         description: Internal server error
 */
router.put("/:id", checkAuthenticated, branchController.updateItemById);
 ...
 *         description: Internal server error
 */
router.delete("/:id", checkAuthenticated, branchController.deleteItemById);
