...
import itemController from "../../controllers/item/item.controller.js";
 ...
 */
router.get("/", checkAuthenticated, itemController.getItems);
 ...
 *         description: Internal server error
 */
router.post("/", checkAuthenticated, itemController.createItem);
 ...
 *         description: Internal server error
 */
router.get("/:id", checkAuthenticated, itemController.getItemById);
 ...
 *         description: Internal server error
 */
router.put("/:id", checkAuthenticated, itemController.updateItemById);
 ...
 *         description: Internal server error
 */
router.delete("/:id", checkAuthenticated, itemController.deleteItemById);
