...
import appointmentTypeController from "../../controllers/appointment-type/appointmentType.controller";
 ...
 */
router.get("/", checkAuthenticated, appointmentTypeController.getItems);
 ...
 *         description: Internal server error
 */
router.post("/", checkAuthenticated, appointmentTypeController.createItem);
 ...
 *         description: Internal server error
 */
router.get("/:id", checkAuthenticated, appointmentTypeController.getItemById);
...
router.put(
  "/:id",
  checkAuthenticated,
  appointmentTypeController.updateItemById
);
...
router.delete(
  "/:id",
  checkAuthenticated,
  appointmentTypeController.deleteItemById
);
