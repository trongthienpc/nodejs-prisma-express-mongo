...
import appointmentStatusController from "../../controllers/appointment-status/appointmentStatus.controller.js";
 ...
 */
router.get("/", checkAuthenticated, appointmentStatusController.getItems);
 ...
 *         description: Internal server error
 */
router.post("/", checkAuthenticated, appointmentStatusController.createItem);
 ...
 *         description: Internal server error
 */
router.get("/:id", checkAuthenticated, appointmentStatusController.getItemById);
...
router.put(
  "/:id",
  checkAuthenticated,
  appointmentStatusController.updateItemById
);
...
router.delete(
  "/:id",
  checkAuthenticated,
  appointmentStatusController.deleteItemById
);
