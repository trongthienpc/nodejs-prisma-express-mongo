...
import itemCategoryController from "../../controllers/itemCategory/itemCategory.controller.js";
 ...
 */
router.get("/", checkAuthenticated, itemCategoryController.getItems);
 ...
 *         description: Internal server error
 */
router.post("/", checkAuthenticated, itemCategoryController.createItem);
 ...
 *         description: Internal server error
 */
router.get("/:id", checkAuthenticated, itemCategoryController.getItemById);
 ...
 *         description: Internal server error
 */
router.put("/:id", checkAuthenticated, itemCategoryController.updateItemById);
...
router.delete(
  "/:id",
  checkAuthenticated,
  itemCategoryController.deleteItemById
);
